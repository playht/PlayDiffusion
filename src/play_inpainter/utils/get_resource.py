import os
import re
from play_inpainter.utils.loading import save_resource
...
if __name__ == '__main__':
    #print(get_resource("s3://peregrine-voices/oliver_ads_parrot_saad/manifest.json", True))
    print(get_resource('filze:/tmp/foo.txt'))
